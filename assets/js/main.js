...
const scrollActive = () =>{
    ...
    sections.forEach(current =>{
        const selectionHeight = current.offsetHeight,
              selectionTop = current.offsetTop - 58,
              selectionId = current.getAttribute('id'),
              selectionClass = document.querySelector('.nav__menu a[href*=' + sectionId + ']')
        if(scrollDown > selectionTop && scrollDown <= selectionTop + selectionHeight){
